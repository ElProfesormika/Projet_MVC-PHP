...
<div class="container mt-5">
  ...
  <h2>Sélectionnez un projet à planifier</h2>

  <form method="post" action="router1.php?action=planningProjet" class="w-50">
    <div class="mb-3">
      <label for="id_projet" class="form-label">Projet</label>
      <select class="form-select" name="id_projet" id="id_projet" required>
